...
public class ValoresCoordenadas extends javax.swing.JFrame {
    ...
    public ValoresCoordenadas() {
        ...
        //g.drawImage(icon.getImage(), 0, 0, 200, 200, null);
    }
    /*
    @Override
...
*/
    ...
    private void initComponents() {
        ...
        deslizamientoHorizontal.setMajorTickSpacing(50);
        deslizamientoHorizontal.setMaximum(800);
        deslizamientoHorizontal.setMinimum(5);
        ...
        jSangulo1.setName(""); // NOI18N
        jSangulo1.setNextFocusableComponent(this);
        jSangulo1.setOpaque(false);
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(jSangulo1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(16, 16, 16)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jSangulo1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        brazoRobotico.setBounds(0, 0, 400, 400);
        brazoRobotico.setVisible(true);
        brazoRobotico.setTitle("Brazo Robotico");
        brazoRobotico.setLocationRelativeTo(null);
        brazoRobotico.setVisible(true);
        brazoRobotico.setResizable(false);
        brazoRobotico.setLocation(285, 2);
        //setLocation(int 20,int 20);
        //brazoRobotico.setMaximumSize ( new Dimension ( 801, 720 ) );
        //brazoRobotico.setMinimumSize ( new Dimension ( 800, 720 ) );
        brazoRobotico.setSize(800, 800);
        */
        int ancho=800;
        int alto=600;
        Ventana dibujar=new Ventana(plataforma,  s1,  s2,  s3,  sGD1,  sGI1,  sGD2,  sGI2, ancho, alto);
        dibujar.setSize(ancho,alto);
        dibujar.setLocationRelativeTo(null);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        this.g.drawImage(icon.getImage(), 0, 0, 200, 200, null);        // TODO add your handling code here:
